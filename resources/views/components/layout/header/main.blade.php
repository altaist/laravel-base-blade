        ...
        <div class="container">
            ...
            <nav class="header2-nav d-none d-md-flex">
                <div class="d-flex align-items-center gap-2">
                    <a href="{{ route('home') }}" class="header2-nav-link {{ request()->routeIs('home') ? 'active' : '' }}">
                        Главная
                    </a>
                    <a href="{{ route('articles.index') }}" class="header2-nav-link {{ request()->routeIs('articles.*') ? 'active' : '' }}">
                        Статьи
                    </a>
                    <a href="#contact" class="header2-nav-link">
                        Контакты
                    </a>
                </div>
            </nav>
